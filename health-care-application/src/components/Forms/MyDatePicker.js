...
export default function MyDatePicker(props) {
    ...
    const getday = ()=>{
        ...
        if (mon != undefined){
            ...
            } else if(mon==='เมษายน' || mon==='มิถุนายน'|| mon==='กันยายน'|| mon==='พฤศจิกายน') {
                console.log(6)
                // setDays([])
                loopDays(30)
            } else {
    ...
    return (
        <div className="row">
            ...
            //   style={{ width: 300 }}
            renderInput={(params) => <TextField {...params} label="ปี พ.ศ." variant="outlined" value={yea} onClick={getyear} />}
            />
            </div>
            <div className="col-12 col-xl-4 mb-15">
            <Autocomplete
            ...
            disableClearable={true}
            //   style={{ width: 300 }}
            renderInput={(params) => <TextField {...params} label="เดือน" variant="outlined" onClick={(e)=>setMon(e.target.value)} />}
            />
            </div>
            ...
            disableClearable={true}
            //   style={{ width: 300 }}
            renderInput={(params) => <TextField {...params} label="วัน" variant="outlined" onClick={getday} />}
            />
            </div>
