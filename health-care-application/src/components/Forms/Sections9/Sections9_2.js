  ...
  return (
    <div className="css-form">
      <form action="#" className="shadow-lg p-3 mb-5 bg-white rounded">
        ...
        <div className="question">
          ...
          <div id="myDIV">
            ...
            <hr />
            <p>
              2.ท่านมีปัญหาเรื่องเข่าในการทำกิจวัตรประจำวันด้วยตัวเองหรือไม่
              เช่น การยืนอาบน้ำเป็นต้น
            </p>
            <RadioGroup
              className="pl-20"
              aria-label="questions6.Im"
            ...
            <p>
              3.ท่านมีปัญหาเรื่องเข่า เมื่อก้าวขึ้นลงรถหรือรถประจำทางหรือไม่
            </p>
            <RadioGroup
              className="pl-20"
              aria-label="questions6.Im"
            ...
            <hr />
            <p>
              6.ท่านต้องเดินโยกตัว(เดินกะโผลกกะเผลก)
      ...
      <Dialog
        ...
        fullWidth={true}
      >
        <DialogTitle>ผลการประเมินโรคข้อเข่าเสื่อม</DialogTitle>
