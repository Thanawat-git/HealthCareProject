...
export default function Sections9_1() {
  const questions = ["เคยพลัดตกหกล้มในช่วงปีที่ผ่านมา", "ใช้ไม้เท้าหรืออุปกรณ์ช่วยเดิน", "บางครั้งมีความรู้สึกว่าเดินไม่ค่อยมั่นคง", "ต้องจับเฟอร์นเจอร์เพื่อประคองตนเองขณะเดินในบ้าน",
