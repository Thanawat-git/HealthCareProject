          ...
          <TableBody>
            {rows.map((row) => (
              <StyledTableRow key={row.Age}>
                ...
                <StyledTableCell align="center">{row.PercentMale==="NaN %"? "0 %" : row.PercentMale}</StyledTableCell>
                <StyledTableCell align="center">{row.PercentFemale==="NaN %"? "0 %" : row.PercentFemale}</StyledTableCell>
