...
const ShowChart = React.forwardRef((props, ref) => {
  ...
  React.useEffect(() => {
    ...
    for (let i = 0; i < communi.length; i++) {
      rows.push(
        createData(Object.keys(chart5Reducer.results)[i],
          communi[i].Alone.Sum,
          communi[i].Alone.PerSum==="NaN"? "0":communi[i].Alone.PerSum,
          communi[i].Alone.AloneDay,
          communi[i].Alone.PerAloneDay==="NaN"? "0":communi[i].Alone.PerAloneDay,
          communi[i].Alone.AloneDayNight,
          communi[i].Alone.PerAloneDayNight==="NaN"? "0":communi[i].Alone.PerAloneDayNight,
          communi[i].Alone.AloneNight,
          communi[i].Alone.PerAloneNight==="NaN"? "0":communi[i].Alone.PerAloneNight,
          communi[i].NotAlone,
