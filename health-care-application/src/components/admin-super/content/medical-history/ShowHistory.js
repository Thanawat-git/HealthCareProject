    ...
    if (historyReducer.isError === false) {
      return (
        <React.Fragment>
          <Accordion
            expanded={open1}
            onClick={() => handleClick("open1", open1)}
          >
          ...
          <Accordion
            expanded={open2}
            onClick={() => handleClick("open2", open2)}
          >
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>
                แบบประเมินความเสี่ยงต่อโรคหัวใจและหลอดเลือด
          ...
          <Accordion
            expanded={open3}
            onClick={() => handleClick("open3", open3)}
          >
            <AccordionSummary
          ...
          <Accordion
            expanded={open4}
            onClick={() => handleClick("open4", open4)}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-label="Expand"
            ...
            <AccordionDetails>
              <Typography color="textSecondary">
                ...
                <strong>
                  {" "}
                  {oral_result !== null ? oral_result : noResult}{" "}
                </strong>
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion
            expanded={open5}
            onClick={() => handleClick("open5", open5)}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-label="Expand"
          ...
          <Accordion
            expanded={open6}
            onClick={() => handleClick("open6", open6)}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-label="Expand"
          ...
          <Accordion
            expanded={open7}
            onClick={() => handleClick("open7", open7)}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-label="Expand"
          ...
          <Accordion
            expanded={open8}
            onClick={() => handleClick("open8", open8)}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-label="Expand"
            ...
            <AccordionDetails>
              <Typography color="textSecondary">
                ...
                ตอนที่ 3 แบบประเมินระดับความรุนแรงของโรคข้อเข่าเสื่อม (Oxford
                Knee Score)
                <p>
                  ผลการประเมิน:{" "}
                  {ost_3_result !== null ? (
          ...
          <Accordion
            expanded={open9}
            onClick={() => handleClick("open9", open9)}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-label="Expand"
          ...
          <Grid container justify="space-between">
            ...
            >Print this page</button> */}
              <div style={{ marginBottom: 10 }}>
                <PrintResultOnly visdate="Print results" />{" "}
              </div>
