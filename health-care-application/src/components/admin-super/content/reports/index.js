...
export default function Index() {
  ...
  React.useEffect(()=>{
     ...
     if(f1===false&&f2===false&&!f3){setLoading2(false)}
     if(f9===false&&f10===false){setLoading4(false)}
      ...
      <Route path={`${path}/report-menu`}>
        ...
        <div className="report-box">
          <Link onClick={()=>handleClick("เอว")}>
            <ReportMenuBox title="แปลผลเส้นรอบเอว" eachImg="1" loading={loading1}/>
          </Link>

          <Link onClick={()=>handleClick("bmi")}>
            <ReportMenuBox title="ดัชนีมวลกาย (BMI)" eachImg="2" loading={loading2}/>
          </Link>
          ...
          <Link onClick={()=>handleClick("cardio")}>
            <ReportMenuBox title="แปลผลความเสี่ยงต่อโรคหัวใจและหลอดเลือด" eachImg="5" loading={loading4}/>
          </Link>

          {/* <ReportMenuBox title="สุขภาพตา" eachImg="6" /> */}
          <Link onClick={()=>handleClick("สุขภาพช่องปาก")}>
            <ReportMenuBox title="สุขภาพช่องปาก" eachImg="7" loading={loading5}/>
          </Link>

          <Link onClick={()=>handleClick("abl")}>
            <ReportMenuBox title="ความสามารถในการทำกิจวัตรประจำวัน" eachImg="8" loading={loading6}/>
          </Link>

          {/* <ReportMenuBox title="TAI" eachImg="9" /> */}
          <Link onClick={()=>handleClick("ภาวะสมองเสื่อม")}>
            <ReportMenuBox title="ภาวะสมองเสื่อม" eachImg="10" loading={loading7}/>
          </Link>
